...
namespace Testinator.WebApp
{
    ...
    /// </summary>
    public class TestCreatorTestInfoPageViewModel : BasePageViewModel
    {
        ...
        /// Default constructor
        /// </summary>
        public TestCreatorTestInfoPageViewModel(NavigationManager navigationManager, ITestCreatorService testCreatorService) : base(navigationManager)
        {
            // Inject DI services
        ...
        private void Submit()
        {
            ...
            if (mEditor.Validate())
            {
                ...
                mNavigationManager.NavigateTo("testcreator/questions");
            }
