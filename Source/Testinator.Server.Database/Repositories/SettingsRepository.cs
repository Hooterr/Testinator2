...
namespace Testinator.Server.Database
{
    ...
    /// </summary>
    public class SettingsRepository : BaseRepository<Setting, int, TestinatorServerDbContext>, ISettingsRepository
    {
        ...
        public SettingsRepository(TestinatorServerDbContext dbContext) : base(dbContext) { }
