    ...
    public class ImagesEditorViewModel : BaseViewModel
    {
        ...
        private void AddImage()
        {
            if (CanAddImages)
            {
                ...
                var fileName = mUIManager.ShowSingleFileDialog(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "png files (*.png)|*.png|jpg files (*.jpg)|*.jpg|bmp files (*.bmp)|*.bm/p");
        ...
        /// Default constructor
        /// </summary>
        public ImagesEditorViewModel(IUIManager uiManager, ILogFactory logger)
        {
            // Inject DI services
        ...
        private int GetIndex(object param)
        {
            ...
            {
                mLogger.Log("Developer error. Code: 2");
                return -1;
            }
            return index;
        }
