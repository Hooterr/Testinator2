...
namespace Testinator.Client.Domain
{
    ...
    public class LoginViewModel : BaseViewModel
    {
        ...
        public string Name
        {
            get => mClientModel.Name;
            set => mClientModel.Name = value;
        }
        ...
        {
            get => mClientModel.LastName;
            set => mClientModel.LastName = value;
        }
        ...
        /// </summary>
        public bool ConnectingIsRunning => mClientNetwork.IsTryingToConnect;
        ...
        /// </summary>
        public int Attempts => mClientNetwork.Attempts;
        ...
        /// Default constructor
        /// </summary>
        public LoginViewModel(IClientModel clientModel, IClientNetwork clientNetwork, IUIManager uiManager, ILogFactory logger)
        {
            // Inject DI services
            ...
            mClientNetwork.ConnectionFinished += Network_ConnectionFinished;
        ...
        {
            // Disconnect
            mClientNetwork.Disconnect();

            // Log it
            mLogger.Log("User disconnected");
        ...
        {
            // If these properties are changed dont do anything
