...
namespace Testinator.Client.Domain
{
    ...
    public class ResultQuestionsViewModel : PageHostViewModel
    {
        ...
        /// Default constructor
        /// </summary>
        public ResultQuestionsViewModel(ITestHost testHost, ApplicationViewModel applicationVM, ILogFactory logger) : base(logger)
        {
            // Inject DI services
            mTestHost = testHost;
        ...
        private void Return()
        {
            mApplicationVM.GoToPage(ApplicationPage.ResultOverviewPage);
        }
